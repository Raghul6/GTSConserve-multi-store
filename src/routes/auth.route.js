...
import { loginHandler,loginForm,logoutHandler,getProfile ,updateProfile} from "../controllers/auth/auth.controller"
...
authRouter.get('/get_change_password', logoutHandler)
