...
export const updateCategory = async (req, res) => {
  try {
    ...
    if (subscription == undefined && addon == undefined) {
      ...
      return res.redirect("/super_admin/orders/active_orders");
    }
    ...
    if (addon) {
      ...
      res.redirect("/super_admin/orders/active_orders");
  } catch (error) {
    console.log(error);
    res.redirect("/home");
  }
...
export const getCategory = async (req, res) => {
  try {
    ...
    if (data_length.length === 0) {
      return res.render("super_admin/orders/active_orders", {
        data: data_length,
        searchKeyword,
        productType,
      });
    ...
    let {
      ...
      iterator,
      endingLink,
    } = await getPageNumber(req, res, data_length, "orders/active_orders");
    ...
    loading = false;
    res.render("super_admin/orders/active_orders", {
      data,
      page,
      iterator,
      endingLink,
