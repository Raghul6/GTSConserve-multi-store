...
export const getAllProductType = async (req, res) => {
  try {
    ...
    if (data_length.length === 0) {
      loading = false
      return res.render("super_admin/menu/product_type", {
        data: data_length,
        searchKeyword,
    ...
    let {
      ...
      iterator,
      endingLink,
    } = await getPageNumber(req,res, data_length, "menu/get_all_product_type");
    ...
    loading = false;
    res.render("super_admin/menu/product_type", {
      data: data,
      page,
      iterator,
      endingLink,
