...
exports.transporter = exports.riderSendNotification = exports.getPasswordResetURL = void 0;
...
var riderSendNotification = /*#__PURE__*/function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            instance = axios.create({
              ...
              headers: {
                authorization: "Basic ".concat(process.env.RIDER_REST_API_KEY)
              }
            });
            console.log("hi2");
            ...
            _context.next = 7;
            return instance.post("?app_id\n      \n      =".concat(process.env.RIDER_APP_ID), data);
          case 7:
  ...
  return function riderSendNotification(_x) {
...
//     console.log(e);
//   });
exports.riderSendNotification = riderSendNotification;
