...
var getCancelled = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return _db["default"].raw("SELECT subscribed_user_details.id FROM subscribed_user_details JOIN users ON users.id = subscribed_user_details.user_id WHERE subscribed_user_details.branch_id = ".concat(admin_id, "   subscribed_user_details.subscription_status = \"branch_cancelled\" AND users.user_unique_id LIKE '%").concat(searchKeyword, "%'"));
          case 8:
            ...
            return _context.abrupt("return", res.redirect("/branch_admin/subscription/cancelled"));
          case 15:
            _context.next = 20;
            break;
          case 17:
          ...
          case 22:
            ...
            loading = false;
            return _context.abrupt("return", res.render("branch_admin/subscription/cancelled", {
              data: data_length,
          ...
          case 26:
            _context.next = 28;
            return (0, _helper.getPageNumber)(req, res, data_length, "subscription/cancelled");
          case 28:
          ...
          case 43:
            _context.next = 45;
            return _db["default"].raw("SELECT sub.id ,sub.start_date,sub.quantity,sub.customized_days,sub.status,subscription_type.name as subscription_name,users.user_unique_id as customer_id,users.mobile_number,users.name as user_name,\n            user_address.address,user_address.landmark,products.name as product_name,products.price,products.unit_value,\n            unit_types.value,categories.name as category_name\n            FROM subscribed_user_details AS sub \n            JOIN subscription_type ON subscription_type.id = sub.subscribe_type_id \n            JOIN users ON users.id = sub.user_id \n            JOIN user_address ON user_address.id = sub.user_address_id\n            JOIN products ON products.id = sub.product_id\n            JOIN unit_types ON unit_types.id = products.unit_type_id\n            JOIN categories ON categories.id = products.category_id\n            WHERE sub.subscription_status = \"branch_cancelled\" AND sub.branch_id = ".concat(admin_id, " LIMIT ").concat(startingLimit, ",").concat(resultsPerPage));
          case 45:
            results = _context.sent;
          case 46:
            data = results[0];
  ...
  return function getCancelled(_x, _x2) {
