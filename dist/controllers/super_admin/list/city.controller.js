      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", res.redirect("/super_admin/list/promo_code"));
          case 14:
            _context.next = 19;
            break;
          case 16:
          ...
          case 19:
            ...
            loading = false;
            return _context.abrupt("return", res.render("super_admin/list/promo_code", {
              data: data_length,
          ...
          case 42:
            data = results[0];
            loading = false;
            res.render("super_admin/list/promo_code", {
              data: data,
              page: page,
              iterator: iterator,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", res.redirect("/super_admin/list/promo_code"));
          case 5:
            query = {
              name: name
            };
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            req.flash("error", "Name is missing");
            return _context3.abrupt("return", res.redirect("/super_admin/list/promo_code"));
          case 5:
            query = {};
            query.name = name;
            if (latitude) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            req.flash("success", "Updated SuccessFully");
            return _context4.abrupt("return", res.redirect("/super_admin/list/promo_code"));
          case 13:
            _context4.prev = 13;
