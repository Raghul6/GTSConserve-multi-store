...
var getCancelList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return _db["default"].raw("SELECT subscribed_user_details.id FROM subscribed_user_details JOIN users ON users.id = subscribed_user_details.user_id WHERE subscribed_user_details.subscription_status = \"cancelled\" AND users.user_unique_id LIKE '%".concat(searchKeyword, "%'"));
          case 7:
            ...
            return _context.abrupt("return", res.redirect("/super_admin/users_subscription/get_cancel_list"));
          case 14:
            _context.next = 19;
            break;
          case 16:
          ...
          case 21:
            ...
            loading = false;
            return _context.abrupt("return", res.render("super_admin/users_subscription/cancel", {
              data: data_length,
          ...
          case 25:
            _context.next = 27;
            return (0, _helper.getPageNumber)(req, res, data_length, "users_subscription/get_cancel_list");
          case 27:
          ...
          case 42:
            _context.next = 44;
            return _db["default"].raw("SELECT sub.id ,sub.start_date,sub.quantity,sub.customized_days,sub.status,subscription_type.name as subscription_name,users.user_unique_id as customer_id,users.mobile_number,users.name as user_name,\n        user_address.address,user_address.landmark,products.name as product_name,products.price,products.unit_value,\n        unit_types.value,categories.name as category_name\n        FROM subscribed_user_details AS sub \n        JOIN subscription_type ON subscription_type.id = sub.subscribe_type_id \n        JOIN users ON users.id = sub.user_id \n        JOIN user_address ON user_address.id = sub.user_address_id\n        JOIN products ON products.id = sub.product_id\n        JOIN unit_types ON unit_types.id = products.unit_type_id\n        JOIN categories ON categories.id = products.category_id\n        WHERE sub.subscription_status = \"cancelled\"  LIMIT ".concat(startingLimit, ",").concat(resultsPerPage));
          case 44:
            results = _context.sent;
          case 45:
            data = results[0];
  ...
  return function getCancelList(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getCancelList = getCancelList;