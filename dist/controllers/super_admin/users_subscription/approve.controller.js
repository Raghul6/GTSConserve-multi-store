...
var getApproveList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return _db["default"].raw("SELECT subscribed_user_details.id FROM subscribed_user_details JOIN users ON users.id = subscribed_user_details.user_id WHERE subscribed_user_details.subscription_status NOT IN (\"cancelled\",\"pending\") AND users.user_unique_id LIKE '%".concat(searchKeyword, "%'"));
          case 7:
            ...
            return _context.abrupt("return", res.redirect("/super_admin/users_subscription/get_assign_list"));
          case 14:
            _context.next = 19;
            break;
          case 16:
            _context.next = 18;
            return (0, _db["default"])("subscribed_user_details").select("id").whereNotIn("subscription_status", ["cancelled", "pending"]);
          case 18:
          ...
          case 21:
            ...
            loading = false;
            return _context.abrupt("return", res.render("super_admin/users_subscription/approve", {
              data: data_length,
          ...
          case 25:
            _context.next = 27;
            return (0, _helper.getPageNumber)(req, res, data_length, "users_subscription/get_assign_list");
          case 27:
  ...
  return function getApproveList(_x, _x2) {
